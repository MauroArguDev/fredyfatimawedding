...
const UnitTile = ({
  ...
  <div className="flex flex-col items-center gap-1">
    <div className="flex size-10 items-center justify-center rounded-invitation-sm bg-surface-dark sm:size-12">
      <p className="font-sans text-base font-bold tabular-nums text-text-on-dark sm:text-xl">
...
const UnitSeparator = (): ReactNode => (
  <span aria-hidden="true" className="pb-5 text-lg font-bold text-text-body">
    :
  </span>
);
  ...
  return (
    <div className="relative w-full">
      <img
        ...
        className="w-full"
      />
      <div className="absolute inset-x-[10%] inset-y-[27%] flex items-center justify-center">
        {breakdown.isPast ? (

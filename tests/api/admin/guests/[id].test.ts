...
import { deleteGuestById, updateGuest } from '../../../../api/_lib/guests';
import handler from '../../../../api/admin/guests/[id]';
import type { GuestRecord } from '../../../../api/_lib/guests';
import type { VercelRequest, VercelResponse } from '@vercel/node';

vi.mock('../../../../api/_lib/adminAuth', () => ({ withAdminAuth: (fn: unknown) => fn }));
vi.mock('../../../../api/_lib/guests', () => ({ updateGuest: vi.fn(), deleteGuestById: vi.fn() }));

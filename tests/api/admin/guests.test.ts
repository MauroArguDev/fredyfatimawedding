...
import { createGuest, listGuests } from '../../../api/_lib/guests';
import handler from '../../../api/admin/guests';
import type { GuestListItem } from '../../../api/_lib/guests';
import type { VercelRequest, VercelResponse } from '@vercel/node';

vi.mock('../../../api/_lib/adminAuth', () => ({ withAdminAuth: (fn: unknown) => fn }));
vi.mock('../../../api/_lib/guests', () => ({ listGuests: vi.fn(), createGuest: vi.fn() }));

...
describe('EnvelopeGate', () => {
  it('isARealButtonWithADescriptiveAccessibleName', () => {
    render(<EnvelopeGate titleLabel="Tío Orlando y Familia." onOpen={vi.fn()} onTap={vi.fn()} />);
  ...
  it('disablesTheButtonWhileOpeningSoItCannotBeReactivatedByTheKeyboardEither', async () => {
    const user = userEvent.setup();
    render(<EnvelopeGate titleLabel="Orlando" onOpen={vi.fn()} onTap={vi.fn()} />);
  ...
  it('callsOnTapSynchronouslyOnTheTapItselfRatherThanAfterTheOpeningAnimation', async () => {
    const user = userEvent.setup();
    const onTap = vi.fn();
    render(<EnvelopeGate titleLabel="Orlando" onOpen={vi.fn()} onTap={onTap} />);
  ...
  it('neverCallsOnTapMoreThanOnceEvenWhenTappedRepeatedlyWhileOpening', async () => {
    const user = userEvent.setup();
    const onTap = vi.fn();
    render(<EnvelopeGate titleLabel="Orlando" onOpen={vi.fn()} onTap={onTap} />);
